...
var EuiIcon = function EuiIcon(_ref) {
  ...
  var classes = (0, _classnames2.default)('euiIcon', className, sizeToClassNameMap[size], colorToClassMap[color]);

  var Svg = typeToIconMap[type] || empty;

  return _react2.default.createElement(Svg, _extends({ className: classes }, rest));
};
