...
const ENABLE_INSTRUCTIONS = exports.ENABLE_INSTRUCTIONS = {
  OSX: {
    ...
    commands: ['./metricbeat modules enable apache'],
    textPost: 'Modify the settings in the `modules.d/apache.yml` file.'
  },
  DEB: {
    title: 'Enable and configure the apache module',
    commands: ['sudo metricbeat modules enable apache'],
  ...
  WINDOWS: {
    ...
    commands: ['PS C:\\Program Files\\Metricbeat> metricbeat.exe modules enable apache'],
    textPost: 'Modify the settings in the `modules.d/apache.yml` file.'
  }
};
