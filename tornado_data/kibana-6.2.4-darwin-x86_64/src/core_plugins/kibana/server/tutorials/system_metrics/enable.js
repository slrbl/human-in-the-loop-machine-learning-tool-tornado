...
const ENABLE_INSTRUCTIONS = exports.ENABLE_INSTRUCTIONS = {
  OSX: {
    ...
    commands: ['./metricbeat modules enable system'],
    textPost: 'Modify the settings in the `modules.d/system.yml` file.'
  },
  DEB: {
    title: 'Enable and configure the system module',
    commands: ['sudo metricbeat modules enable system'],
  ...
  WINDOWS: {
    ...
    commands: ['PS C:\\Program Files\\Metricbeat> metricbeat.exe modules enable system'],
    textPost: 'Modify the settings in the `modules.d/system.yml` file.'
  }
};
