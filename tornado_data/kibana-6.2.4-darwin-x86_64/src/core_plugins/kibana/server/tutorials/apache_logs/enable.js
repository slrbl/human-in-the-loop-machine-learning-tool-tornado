...
const ENABLE_INSTRUCTIONS = exports.ENABLE_INSTRUCTIONS = {
  OSX: {
    ...
    commands: ['./filebeat modules enable apache2'],
    textPost: 'Modify the settings in the `modules.d/apache2.yml` file.'
  },
  DEB: {
    title: 'Enable and configure the apache2 module',
    commands: ['sudo filebeat modules enable apache2'],
  ...
  WINDOWS: {
    ...
    commands: ['PS C:\\Program Files\\Filebeat> filebeat.exe modules enable apache2'],
    textPost: 'Modify the settings in the `modules.d/apache2.yml` file.'
  }
};
