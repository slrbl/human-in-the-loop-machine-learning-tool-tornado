...
const ELASTIC_CLOUD_INSTRUCTIONS = exports.ELASTIC_CLOUD_INSTRUCTIONS = {
  instructionSets: [{
    ...
    instructionVariants: [{
      ...
      instructions: [_filebeat_instructions.FILEBEAT_INSTRUCTIONS.INSTALL.WINDOWS, _filebeat_cloud_instructions.FILEBEAT_CLOUD_INSTRUCTIONS.CONFIG.WINDOWS, _enable.ENABLE_INSTRUCTIONS.WINDOWS, _filebeat_instructions.FILEBEAT_INSTRUCTIONS.START.WINDOWS]
    }]
  }]
};
